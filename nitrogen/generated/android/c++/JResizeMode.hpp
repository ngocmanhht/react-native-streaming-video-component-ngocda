...
namespace margelo::nitro::streamingvideo {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/com/streamingvideongocda/ResizeMode;";
    ...
    static jni::alias_ref<JResizeMode> fromCpp(ResizeMode value) {
      ...
      switch (value) {
        ...
        case ResizeMode::FILL:
          static const auto fieldFILL = clazz->getStaticField<JResizeMode>("FILL");
