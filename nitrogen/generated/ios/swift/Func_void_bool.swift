...
/**
 * Wraps a Swift `(_ isBuffering: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.streamingvideo.bridge.swift

  private let closure: (_ isBuffering: Bool) -> Void

  public init(_ closure: @escaping (_ isBuffering: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isBuffering: Bool) -> Void {
    self.closure(isBuffering)
  }
