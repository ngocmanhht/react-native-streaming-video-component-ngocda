...
namespace margelo::nitro::streamingvideo {
  ...
  public:
    ...
    double playableDuration     SWIFT_PRIVATE;

  public:
    ProgressEvent() = default;
    explicit ProgressEvent(double currentTime, double duration, double playableDuration): currentTime(currentTime), duration(duration), playableDuration(playableDuration) {}
...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::streamingvideo::ProgressEvent> final {
    static inline margelo::nitro::streamingvideo::ProgressEvent fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::streamingvideo::ProgressEvent(
        ...
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "playableDuration")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::streamingvideo::ProgressEvent& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "playableDuration"), JSIConverter<double>::toJSI(runtime, arg.playableDuration));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "playableDuration")))) return false;
      return true;
    }
  };
