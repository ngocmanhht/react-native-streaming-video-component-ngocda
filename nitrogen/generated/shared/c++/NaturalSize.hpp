...
namespace margelo::nitro::streamingvideo {
  ...
  /**
   * A struct which can be represented as a JavaScript object (NaturalSize).
   */
  struct NaturalSize final {
  public:
  ...
  public:
    NaturalSize() = default;
    explicit NaturalSize(double width, double height): width(width), height(height) {}

  public:
    friend bool operator==(const NaturalSize& lhs, const NaturalSize& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ NaturalSize <> JS NaturalSize (object)
  template <>
  struct JSIConverter<margelo::nitro::streamingvideo::NaturalSize> final {
    static inline margelo::nitro::streamingvideo::NaturalSize fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::streamingvideo::NaturalSize(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::streamingvideo::NaturalSize& arg) {
