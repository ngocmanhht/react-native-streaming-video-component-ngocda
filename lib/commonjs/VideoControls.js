...
const SeekBar = ({
  ...
  const [value, setValue] = (0, _react.useState)(currentTime);
  const isSliding = (0, _react.useRef)(false);
  const lastSeekTime = (0, _react.useRef)(0);
  ...
  const handleValueChange = (0, _react.useCallback)(val => {
    setValue(val);
  ...
  const handleSlidingStart = (0, _react.useCallback)(() => {
    isSliding.current = true;
  }, []);
  const handleSlidingComplete = (0, _react.useCallback)(val => {
